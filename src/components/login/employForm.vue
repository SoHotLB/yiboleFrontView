      ...
      <el-row  >
        <el-col :span="16"><div class="grid-content bg-purple-light">
          <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="80px" class="demo-ruleForm">
            <el-form-item  label="用户名" prop="account" style="width: 350px; margin-top: 70px;"  >
              <el-input placeholder="请输入应聘者手机号/用户名" type="text" v-model="ruleForm.account" autocomplete="off"></el-input>
            </el-form-item>
      ...
      <el-row  >
        <el-col   style="margin-top: 50px;"><div class="grid-content bg-purple-light">
          <el-form :model="TelruleForm" status-icon :rules="Telrules" ref="TelruleForm" label-width="80px" class="demo-ruleForm">
            <el-form-item label="手机号码"  placeholder="请输入应聘者11位正确手机号" prop="Telphone" style="width: 350px; " >
    ...
    PasssubmitForm(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$axios.post(this.$store.state.URL+"checkEmployLoginByAccount",
              {
                employAccount:this.ruleForm.account,
                employPassword:this.ruleForm.pass
              }
...
// localStorage.setItem("LoginName",that.ruleForm.account);
    ...
    employRegister(){
      ...
      this.$router.push({path:'/employRegister'})
    }
